...
public final class IntentExtraKeys {
    ...
    public static final String TODO_ITEM_ID = "todo_item_position";
    ...
    public static final String LESSON_PREVIEW = "lesson_preview";
    ...
    public static final String TODAYLIST_ITEM_POSITION = "today_list_item_position";

package com.example.administrator.imovie.utils;
...
public class DimensionUtil {
    ...
    public static int dipToPx(Context context, float dpValue) {
        return (int) (dipToPxF(context,dpValue)+0.5f);
    }

    public static float pxToDipF(Context context, float pxValue) {
        final float scale = context.getResources().getDisplayMetrics().density;
        return pxValue / scale;
    }

    public static int pxToDip(Context context, float pxValue) {
        return (int) (pxToDipF(context,pxValue)+0.5f);
    }

    public static float spToPxF(Context context, float spValue) {
        final float scale = context.getResources().getDisplayMetrics().scaledDensity;
        return spValue * scale;
    }

    public static int spToPx(Context context, float spValue) {
        return (int)spToPxF(context,spValue);
    }
